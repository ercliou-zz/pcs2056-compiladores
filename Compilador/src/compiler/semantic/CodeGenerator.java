...
//		env.append(generateIOFunctions());
		env.append(generateNopFunction());
	...
	private String generateNopFunction(){
		StringBuilder env = new StringBuilder();
		env.append("NOP\tJP\t/0000\r\n");
		env.append("\tRS\tNOP\r\n\r\n");
		return env.toString();
	}
	...
	public void writeOutputFile(String outputPath) {
		...
		try {
			...
			System.out.println("Arquivo de saída não existe.");
		}
	}
